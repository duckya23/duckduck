...
line_bot_api.push_message(1660929518, 
...
#         line_bot_api.reply_message(event.reply_token, image_carousel_template_message)
    ...
    if re.match('好的現在為您開啟表格!鴨鴨!',message):
